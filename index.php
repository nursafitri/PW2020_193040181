...
require 'tubes/php/function.php';
...
<head>
  ...
  <link type="text/css" rel="stylesheet" href="tubes/Assets/css/materialize.min.css" media="screen,projection" />
  <!--Let browser know website is optimized for mobile-->
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />

  <link rel="stylesheet" type="text/css" href="tubes/Assets/css/style.css">

  <link rel="stylesheet" type="text/css" href="tubes/Assets/css/materialize.min.css">
  <title>Index</title>
...
<body>
      ...
      <div class="container">
        <div class="nav-wrapper">
          ...
          <ul class="left hide-on-med-and-down">
            ...
            <li><a href="#index">Index Tugas</a></li>
          </ul>
          <ul class="right hide-on-med-and-down">
            <li><a href="#bantuan">Help</a></li>
            <li><a href="tubes/php/login.php"><i class="material-icons">account_circle</i></a></li>
          </ul>
  ...
  <ul class="sidenav" id="mobile-nav">
    ...
    <li><a href="#index">Index Tugas</a></li>
    <li><a href="#bantuan">Help</a></li>
    <li><a href="tubes/php/login.php"><i class="material-icons">account_circle</i>Log in</a></li>
  ...
  <div class="slider">
    <ul class="slides">
      <li>
        <img src="tubes/Assets/Gambar/Slider/1.jpg">
        <div class="caption center-align">
        </div>
      </li>
      <li>
        <img src="tubes/Assets/Gambar/Slider/3.jpg">
        <div class="caption center-align">
        </div>
      </li>
    </ul>
  ...
  <div id="merek" class="parallax-container scrollspy" style="height: 350px;">
    <div class="parallax"><img src="tubes/Assets/Gambar/CT.jpg"></div>
  ...
  <div id="index" class="container">
    <h3 class="center light red-text">Index Tugas</h3>
    <div class="row">

      <div class="col s12 m4">
        <div class="card sticky-action center">
          <div class="card-image waves-effect waves-block waves-light">
            <img class="activator" src="tubes/Assets/Gambar/portfolio/2.jpg">
          </div>
          <h5 class="red-text">Kuliah Pertemuan 9</h5>
      ...
      <div class="col s12 m4">
        <div class="card sticky-action center">
          ...
          <h5 class="red-text">Kuliah Pertemuan 10</h5>
          <div class="card-action">
      ...
      <div class="col s12 m4">
        <div class="card sticky-action center">
          ...
          <h5 class="red-text">Kuliah Pertemuan 11</h5>
          <div class="card-action">
    ...
    <div class="row">
      <div class="col s12 m4">
        <div class="card sticky-action center">
          ...
          <h5 class="red-text">Kuliah Pertemuan 12</h5>
          <div class="card-action">
      ...
      <div class="col s12 m4">
        <div class="card sticky-action center">
          ...
          <h5 class="red-text">Kuliah Pertemuan 13</h5>
          <div class="card-action">
      ...
      <div class="col s12 m4">
        <div class="card sticky-action center">
          <div class="card-image waves-effect waves-block waves-light">
            <img class="activator" src="tubes/Assets/Gambar/portfolio/1.jpg">
          </div>
          <h5 class="red-text">Praktikum Pertemuan 5</h5>
          <div class="card-action">
            <a href="praktikum/P5_PW_193040181" class="waves-effect waves-light dark grey-text text-darken-3">P5_PW_193040181</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col s12 m4">
        <div class="card sticky-action center">
          ...
          <h5 class="red-text">Praktikum Pertemuan 6</h5>
          <div class="card-action">
            <a href="praktikum/P6_PW_193040181" class="waves-effect waves-light dark grey-text text-darken-3">P6_PW_193040181</a>
          </div>
        </div>
      </div>
      ...
      <div class="col s12 m4">
        <div class="card sticky-action center">
          ...
          <h5 class="red-text">Praktikum Pertemuan 7</h5>
          <div class="card-action">
            <a href="praktikum/P7_PW_193040181" class="waves-effect waves-light dark grey-text text-darken-3">P7_PW_193040181</a>
          </div>
        </div>
      </div>
      ...
      <div class="col s12 m4">
        <div class="card center">
          <div class="card-image waves-effect waves-block waves-light">
            <img class="activator" src="tubes/Assets/Gambar/portfolio/5.jpg">
          </div>
          <h5 class="red-text">Tugas Besar</h5>
          <div class="card-action">
            <a href="tubes/index.php" class="waves-effect waves-light dark grey-text text-darken-3">Index</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <script type="text/javascript" src="tubes/Assets/js/materialize.min.js"></script>
